    ...
    try {
         const result = await DB.Models.TeacherClass.findAll({ include: [
            ...
            },
            {
                ...
                include:[{model: DB.Models.subject,attributes:[['id','subject_id'],'title']}],
                attributes: [['id','teacher_id'],'name','email','phone']
               }
            ],
            attributes: 
            ['id']
...
module.exports.teacherClassdelete = async (data) => {
 ...
 return ({ "status": 200, "success_status": true, "response": " Teacher deleted from class successfully"});
